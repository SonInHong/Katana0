...
public:
	...
	doublepoint GetAnimationScaling() { return AnimationScaling; }
	void SetPos(doublepoint p) { Pos = p; }
	void SetScale(doublepoint p) { Scale = p; }
	void SetResize(doublepoint p) { Resize = p; }
	void SetAnimationScaling(doublepoint p) { AnimationScaling = p; }
	...
	CFloor* GetRecentFloor() { return RecentFloor; } // 길찾기용
